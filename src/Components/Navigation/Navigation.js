...
const Navigation = () => {
  return (
    ...
    >
      <ul className=" space-y-4 sm: flex  items-baseline justify-between space-x-4 md:block lg:block  ">
        <LuLayoutDashboard className="text-sky-200 text-2xl md:text-3xl ml-0 md:ml-4 mb-8" />
        <li>
          <a
            href="#"
            className="flex items-center text-gray-300 hover:text-white p-2 rounded-md"
          >
